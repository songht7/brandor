...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$(".mBlock").hover(function(){
				...
				if(!obj.hasClass("active")){
					slide=setTimeout("slideShow(obj)",100);
				}
			},function(){
				clearTimeout(slide);
			});
		...
		function slideShow(obj){
			...
			obj.addClass("active");
			$(".imgRow").animate({"opacity":"hide"},1000).removeClass("active").eq(_index).animate({"opacity":"show"},1500).addClass("active");
		}
		function resize(){
			var winWidth=$(window).width();
...
<body id="HomePage">
	...
	<div id="MenuBox">
		<div id="Menu" class="clearfix">
			<div class="mBlock active"><a href="/ydc" class="menuLink ydc" target="_blank">艺德诚</a></div><!--ydc/index.php-->
			<div class="mBlock"><a href="/product" class="menuLink gift" target="_blank">gift</a></div><!--gift/index.php-->
			<div class="mBlock"><a href="http://brandor.cn" class="menuLink brandor" target="_blank">BRANDOR</a></div><!--brandor/index.php-->
		</div>
		<div id="Footer" valign="center">
			Copyright 2012-2013 brandor.net Incoprated. All rights reserved. <a href="http://www.miitbeian.gov.cn" target="_blank">粤ICP备12060513号</a>
		</div>
	</div>
</body>
</html>