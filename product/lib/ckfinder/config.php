 ...
 */
session_start();
$fu=explode("/lib/ckfinder/core/connector/php/connector.php",$_SERVER['PHP_SELF']);
$suburl=$fu[0];
...
function CheckAuthentication()
{
	...
	$fu=explode("/lib/ckfinder/core/connector/php/connector.php",$_SERVER['PHP_SELF']);
	$suburl=$fu[0];
	include_once $_SERVER['DOCUMENT_ROOT'].$suburl."/config.inc.php";
	if(isset($_SESSION[$shop_name]['b_lang'])){
		return true;
	}
	return false;
}
...
*/
//$baseUrl = '127.0.0.1/z_JJ/new/website/demo/bls/lib/ckfinder/userfiles/';
$baseUrl = "http://".$_SERVER['HTTP_HOST'].$suburl.'/lib/ckfinder/userfiles/';
